...
A heap is a binary tree where each node is greater than each of its children.  The tree is
...
'''
A heap is based on an array just as a hashmap is based on an array. For a heap, the children of an 
element n are at index 2n+1 for the left child and 2n+2 for the right child.
...
if (__name__ == "__main__"):
    aList = [2,3,4,11,0,22,211,1234,777]
